import {ContextBytesType, EncodedPayloadBytesOutgoing, EncodedPayloadType} from "@lodestar/reqresp";
  ...
  for (const blockRoot of requestBody) {
    ...
    yield {
      ...
      contextBytes: {
        ...
        fork: chain.config.getForkName(getSlotFromSignedBeaconBlock(blockBytes)),
      },
    };
  }
}
